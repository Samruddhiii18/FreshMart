...
type propType={
    perviousStep:(s:number)=>void
}

function RegisterForm({perviousStep}:propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
        ...
        <p className='text-gray-600 mb-8 flex items-center gap-1'>Join FreshMart today <Leaf className='w-5 h-5 text-green-600'/></p> 
