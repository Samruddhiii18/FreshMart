  ...
  return (
    <div className='flex flex-col min-h-screen p-6 w-full items-center'>
        ...
        className='flex flex-col items-center mt-10'>
            ...
            <input type="tel" id='mobile' className='w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none text-gray-800' placeholder='Eg. 7428730894' onChange={(e)=>setMobile(e.target.value)}/>
        </motion.div>
        <motion.button
            initial={{opacity:0, y:20}}
            animate={{opacity:1, y:0}}
