        ...
        return(
            <div className='p-4 pt-[120px] min-h-screen bg-gray-50'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    <p className='text-gray-600 text-sm mb-4'>Order ID #{activeOrder.order._id.slice(-6)}</p>
                    ...
                    <div className='mt-6 bg-white rounded-xl border shadow p-6'>
                        {!activeOrder.order.deliveryOtpVerification && !showOtpBox && (
                            <button className='w-full py-4 bg-green-600 text-center text-white rounded-lg' 
                            onClick={sendOtp}
                        ...
                        )}
                        {
                            ...
                            <div className='mt-4'>
                                ...
                                <button className='w-full mt-4 bg-blue-600 text-white py-3 rounded-lg text-center' onClick={verifyOtp}>{verifyOtpLoading?<Loader size={16} className='animate-spin text-white text-center'/>:"Verify Otp"}</button>
