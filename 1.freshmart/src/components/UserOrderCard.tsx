        ...
        {status !== "delivered" && 
            <div className='p-5 space-y-4'>
                {order.paymentMethod == "cod" ? <div className='flex items-center gap-2 text-gray-700 text-sm'>
                    ...
                    <CreditCard size={16} className='text-green-600'/> Online Payment
                </div>} 
                ...
                {order.assignedDeliveryBoy && <> <div className='mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between'>
                    ...
                    <button className='w-full flex items-center justify-center gap-2 bg-green-600 text-white font-semibold px-4 py-2 rounded-xl shadow hover:br-green-700 transition' onClick={()=>router.push(`/user/track-order/${order._id?.toString()}`)}><TruckIcon size={18}/>Track Your Order</button>
                    </>
                    }
                ...
                <div className='border-t pt-3 flex justify-between items-center text-center text-sm font-semibold text-gray-800'>
                    <div className='flex items-center gap-2 text-gray-700 text-sm'>
