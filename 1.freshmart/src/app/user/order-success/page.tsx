  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 text-center bg-linear-to-b from-green-50 to-white'>
        ...
        >
            ...
            processed.You can track its progress in your <span className='font-semibold 
            text-green-700'>My Orders</span> section.
        </motion.p>
        ...
        className='mt-12'>
            ...
            <motion.div
                ...
                whileTap={{scale:0.93}}
                className='flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-base font-semibold px-8 py-3 rounded-full shadow-lg transition-all cursor-pointer'>Go to My Orders Page<ArrowRight/>
            </motion.div>
            </Link>
        </motion.div>
        ...
        className='absolute top-0 left-0 w-full h-full pointer-events-none'>
            ...
            <div className='absolute top-16 left-[70%] w-2 h-2 bg-green-400 rounded-full animate-bounce'/>
        </motion.div>
