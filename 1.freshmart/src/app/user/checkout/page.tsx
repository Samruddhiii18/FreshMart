...
import { ArrowLeft, Building2, CreditCard, CreditCardIcon, Home, Loader2, LocateFixed, Map, MapPin, MapPinned, Phone, Truck, User } from 'lucide-react'
...
function Checkout() {
    ...
    const fetchAddressFromPosition = async (pos: [number, number]) => {
        try {
        ...
        if(navigator.geolocation){
            navigator.geolocation.getCurrentPosition(
                async (pos) => {
                    ...
                    await fetchAddressFromPosition(newPosition)
                },
                (err) => {
  ...
  return (
    <div className='w-[92%] md:w-[80%] mx-auto py-10 relative'>
        ...
        <motion.button
        whileTap={{scale:0.97}}
        className='absolute left-0 top-2 flex items-center gap-2 text-green-700 hover:text-green-800 font-semibold' onClick={() => router.push("/user/cart")}>
            <ArrowLeft size={16}/>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='grid grid-cols-3 gap-3'>
                        ...
                        <div className='relative'>
                            ...
                            <input type='text' placeholder='State' value={address.state} onChange={(e) => setAddress((prev) => ({...prev,state:e.target.value}))} className='pl-10 w-full border rounded-lg p-3 text-sm bg-gray-50'/>
                        </div>

                        <div className='relative'>
                            <MapPinned className='absolute left-3 top-3 text-green-600' size={18}/>
                    ...
                    <div className='relative mt-6 h-[330px] rounded-xl overflow-hidden border border-gray-200 shadow-inner'>
                        ...
                        {position && (<CheckoutMap position={position} setPosition={setPosition} fetchAddress={fetchAddressFromPosition}/>)}
            ...
            className='bg-white rounded-2xl shadow-lg hover-shadow-xl transition-all duration-300 p-6 border border-gray-100 h-fit'>
                ...
                <div className='space-y-4 mb-6'>
                    ...
                    >
                        ...
                        <span className='font-medium text-gray-700'>UPI (Strip)</span>
                    </button>
