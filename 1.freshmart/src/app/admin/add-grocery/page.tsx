...
const units = ["kg", "liter", "g", "ml", "piece", "pack"]
...
function AddGrocery() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center p-6 relative">
              ...
              className="bg-white w-full max-w-2xl shadow-2xl rounded-3xl border border-green-100 p-8">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-3xl font-bold text-gray-800">Add Your Grocery</h1>
                    </div>
                ...
                <div>
                  ...
                  <input id="name" type="text" placeholder="e.g. Milk, Sugar, Apple..." onChange={(e)=>setName(e.target.value)} value={name} className="w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all"/>
                </div>
                ...
                <div>
                    ...
                    <input id="name" type="text" placeholder="e.g. 120" className="w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all" onChange={(e)=>setPrice(e.target.value)} value={price}/>
                </div>
                ...
                <motion.button type='submit' whileHover={{scale:1.02}} whileTap={{scale:0.9}} disabled={loading} className='mt-4 w-full bg-linear-to-r from-green-500 to-green-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl disable:opacity-60 transition-all flex items-center justify-center gap-2'>
